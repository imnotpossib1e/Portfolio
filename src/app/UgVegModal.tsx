      ...
      <div className="fixed top-1/2 left-1/2 w-[60%] transform -translate-x-1/2 -translate-y-1/2 p-10 overflow-auto  bg-white shadow-lg">
        ...
        <div className="flex flex-col gap-4 mb-4">
          ...
          <div>
            ...
            <p>PL로서 팀원들이 직면한 어려운 문제를 적극 해결하며 원활한 협업과 프로젝트 진행에 기여하며</p>
            <p>이를 통해 기술적 문제 해결 역량을 강화했습니다. </p>
            <p>React와 Next.js 기반 프론트엔드 아키텍처 설계 및 서버 사이드 렌더링(SSR) 최적화를 수행하고,</p>
            <p>
              각 컴포넌트별 API 호출에 따른 렌더링 지연 문제를 신속히 진단하고 최적화하여 페이지 로딩 속도를 50%
              개선하는 성과를 이루었습니다.
            </p>
            <p>
